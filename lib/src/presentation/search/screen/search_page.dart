...
import '../../../data/models/filter.dart' as myfilter;
import '../../../data/models/spending.dart';
import '../../../domain/spending_firebase.dart';
import '../../analytic/widget/my_search_delegate.dart';
import '../../filter/screen/filter_page.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  myfilter.Filter filter =
      myfilter.Filter(chooseIndex: [0, 0, 0], friends: [], colors: []);
