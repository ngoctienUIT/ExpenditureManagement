...
import 'package:expenditure_management/src/presentation/add_spending/widget/more_button.dart';
import 'package:expenditure_management/src/presentation/add_spending/widget/pick_image_widget.dart';
import 'package:expenditure_management/src/presentation/add_spending/widget/remove_icon.dart';
import 'package:expenditure_management/src/presentation/choose_type/screen/choose_type.dart';
...
import '../../../core/function/pick_function.dart';
...
class _EditSpendingPageState extends State<EditSpendingPage> {
  ...
  Future updateSpending() async {
    String moneyString = _money.text.replaceAll(RegExp(r'\D'), '');
    if (type != null &&
